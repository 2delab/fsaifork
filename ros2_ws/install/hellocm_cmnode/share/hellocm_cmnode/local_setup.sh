...
: ${AMENT_CURRENT_PREFIX:="/home/mdxfsai/FS_autonomous/ros/ros2_ws/install/hellocm_cmnode"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hellocm_cmnode/environment/library_path.sh"
